...
struct book *initialize_lib(struct book *start){
 struct book 
*ptr,*new_book1,*new_book2,*new_book3,*new_book4,*new_bo
ok5;
...
__\n");
 ...
 printf("\n\tSorry the book doesn't exist! Please recheck the 
entered ID");
 printf("\n\t\t\t\t Press any key to try again: ");
 getch();
 system("cls");
...
struct book *add_book(char bookname[30],char authorname[30],int 
id){
